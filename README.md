## 📜 프로젝트 소개
API 키를 등록해 다양한 AI 모델을 선택 및 사용할 수 있는 웹 기반 채팅 프로젝트입니다.<br>
무료 사용량이 제공되는 API들을 키 등록만으로 AI 서비스를 이용할 수 있게 해줍니다.<br>

## 🚀 기술 스택
HTML/CSS, Javascript, Express.js, Sequelize, PostgreSQL, Supabase, Oracle Cloud

## ▶️ 데모 링크
http://168.107.34.227.nip.io:3000

## ⚠️ 주의 사항
만일의 상황을 대비해 과금이 되지 않는 **무료 API 키**만 등록하는 것을 추천드립니다.
